    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('q_memorizing', models.JSONField(default=apps.students.utils.json_default_value_618, verbose_name='حفظ القرآن')),
                ('q_test', models.JSONField(default=apps.students.utils.json_default_value_240, verbose_name='السبر في المسجد')),
                ('q_awqaf_test', models.JSONField(default=apps.students.utils.json_default_value_30, verbose_name='سبر القرآن في الأوقاف')),
                ('q_awqaf_test_looking', models.JSONField(default=apps.students.utils.json_default_value_30, verbose_name='سبر القرآن نظراً في الأوقاف')),
                ('q_awqaf_test_explaining', models.JSONField(default=apps.students.utils.json_default_value_30, verbose_name='سبر القرآن تفسيراً في الأوقاف')),
