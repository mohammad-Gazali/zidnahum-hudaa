...
class Coming(models.Model):
  master = models.ForeignKey(
    AUTH_USER_MODEL, verbose_name="اسم الأستاذ", on_delete=models.SET_NULL, null=True
  )
  student = models.ForeignKey(
    "students.Student", verbose_name="اسم الطالب", on_delete=models.PROTECT
  )
  registered_at = models.DateTimeField(auto_now_add=True, verbose_name="تاريخ التسجيل")
  category = models.ForeignKey(
    ComingCategory, on_delete=models.PROTECT, verbose_name="سبب الحضور"
  )
