...
from adminstration.extra_views import AddAwqafNoQTestCreateView, AddAwqafQTestCreateView, AddMoneyDeletingNormalCreateView, AddMoneyDeletingCategoryCreateView, ControlSettingsReadUpdateView, StatisticsView
