...
class UsersGroupsService extends __BaseService {
  ...
  /**
   * @param params The `UsersGroupsService.AuthGroupUpdateParams` containing the following parameters:
   *
   * - `id`:
   *
   * - `data`:
   */
  authGroupUpdateResponse(params: UsersGroupsService.AuthGroupUpdateParams): __Observable<__StrictHttpResponse<GroupUpdate>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
   ...
   * - `data`:
   */
  authGroupUpdate(params: UsersGroupsService.AuthGroupUpdateParams): __Observable<GroupUpdate> {
  ...
  /**
   * @param params The `UsersGroupsService.AuthUserUpdateParams` containing the following parameters:
   *
   * - `id`:
   *
   * - `data`:
   */
  authUserUpdateResponse(params: UsersGroupsService.AuthUserUpdateParams): __Observable<__StrictHttpResponse<UserUpdate>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
   ...
   * - `data`:
   */
  authUserUpdate(params: UsersGroupsService.AuthUserUpdateParams): __Observable<UserUpdate> {
