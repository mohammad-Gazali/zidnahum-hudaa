...
class ReportsService extends __BaseService {
  ...
  reportsCategoryAllCreateResponse(
    params: ReportsService.ReportsCategoryAllCreateParams,
  ): __Observable<
  ...
  reportsCategoryCreateResponse(
    params: ReportsService.ReportsCategoryCreateParams,
  ...
  reportsGroupAllCreateResponse(
    params: ReportsService.ReportsGroupAllCreateParams,
  ...
  reportsGroupCreateResponse(
    params: ReportsService.ReportsGroupCreateParams,
  ): __Observable<__StrictHttpResponse<ReportsStudentCategoryOrGroupResponse>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
  ...
  reportsStudentCreateResponse(
    params: ReportsService.ReportsStudentCreateParams,
  ...
  reportsStudentsAllCreateResponse(
    params: ReportsService.ReportsStudentsAllCreateParams,
  ): __Observable<
