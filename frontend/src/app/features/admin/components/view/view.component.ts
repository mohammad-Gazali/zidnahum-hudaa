...
import { SnackbarService, MemoItemType } from '@shared';
import { TranslatePipe } from '@shared';
import { DateService } from '@admin/services/date.service';
import {
  ViewExtraData,
  ViewField,
  ViewFieldConfig,
...
export class ViewComponent<T, U> implements OnInit, OnDestroy {
  ...
  public fields = signal<ViewField[]>([]);
  public editMode = signal(false);
  public isSuperUser = computed(() => !!this.auth.currentUser()?.isSuperUser);
  public extraData = signal<ViewExtraData>({});
