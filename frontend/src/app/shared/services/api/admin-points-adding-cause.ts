...
export class AdminPointsAddingCauseService {
  ...
  adminActionsPointsAddingCauseDeleteCreate<TData = void>(
    ...
    if (options?.observe === 'events') {
      return this.http.post<TData>(
        `${this.baseUrl}/api/v1/admin/actions/points-adding-cause/delete`,
        idsAction,
        {
  ...
  adminPointsAddingCauseList<TData = PointsAddingCauseList[]>(
    params?: AdminPointsAddingCauseListParams,
    options?: HttpClientBodyOptions,
  ): Observable<TData>;
  adminPointsAddingCauseList<TData = PointsAddingCauseList[]>(
    params?: AdminPointsAddingCauseListParams,
  ...
  adminPointsAddingCauseList<TData = PointsAddingCauseList[]>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`${this.baseUrl}/api/v1/admin/points/adding-cause/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
  ...
  adminPointsAddingCauseCreate<TData = PointsAddingCauseCreate>(
    pointsAddingCauseCreate: PointsAddingCauseCreate,
    options?: HttpClientBodyOptions,
  ): Observable<TData>;
  adminPointsAddingCauseCreate<TData = PointsAddingCauseCreate>(
    pointsAddingCauseCreate: PointsAddingCauseCreate,
  ...
  adminPointsAddingCauseCreate<TData = PointsAddingCauseCreate>(
    ...
    if (options?.observe === 'events') {
      return this.http.post<TData>(
        `${this.baseUrl}/api/v1/admin/points/adding-cause/`,
        pointsAddingCauseCreate,
        {
          ...(options as Omit<NonNullable<typeof options>, 'observe'>),
          observe: 'events',
  ...
  adminPointsAddingCauseRetrieve<TData = PointsAddingCauseList>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`${this.baseUrl}/api/v1/admin/points/adding-cause/${id}/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
      });
    }
  ...
  adminPointsAddingCauseUpdate<TData = PointsAddingCauseUpdate>(
    id: number,
    pointsAddingCauseUpdate: PointsAddingCauseUpdate,
    options?: HttpClientBodyOptions,
  ): Observable<TData>;
  adminPointsAddingCauseUpdate<TData = PointsAddingCauseUpdate>(
    id: number,
  ...
  adminPointsAddingCauseUpdate<TData = PointsAddingCauseUpdate>(
    ...
    if (options?.observe === 'events') {
      return this.http.put<TData>(
        `${this.baseUrl}/api/v1/admin/points/adding-cause/${id}/`,
        pointsAddingCauseUpdate,
        {
          ...(options as Omit<NonNullable<typeof options>, 'observe'>),
          observe: 'events',
  ...
  adminPointsAddingCauseDestroy<TData = void>(
    ...
    if (options?.observe === 'events') {
      return this.http.delete<TData>(`${this.baseUrl}/api/v1/admin/points/adding-cause/${id}/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
      });
    }
