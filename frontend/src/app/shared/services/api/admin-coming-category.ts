...
export class AdminComingCategoryService {
  ...
  adminActionsComingCategoryDeleteCreate<TData = void>(
    ...
    if (options?.observe === 'events') {
      return this.http.post<TData>(
        `${this.baseUrl}/api/v1/admin/actions/coming-category/delete`,
        idsAction,
        {
  ...
  adminComingsCategoryList<TData = ComingCategoryList[]>(
    params?: AdminComingsCategoryListParams,
    options?: HttpClientBodyOptions,
  ): Observable<TData>;
  adminComingsCategoryList<TData = ComingCategoryList[]>(
    params?: AdminComingsCategoryListParams,
  ...
  adminComingsCategoryList<TData = ComingCategoryList[]>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`${this.baseUrl}/api/v1/admin/comings/category/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
  ...
  adminComingsCategoryCreate<TData = ComingCategoryCreate>(
    comingCategoryCreate: ComingCategoryCreate,
    options?: HttpClientBodyOptions,
  ): Observable<TData>;
  adminComingsCategoryCreate<TData = ComingCategoryCreate>(
    comingCategoryCreate: ComingCategoryCreate,
  ...
  adminComingsCategoryCreate<TData = ComingCategoryCreate>(
    ...
    if (options?.observe === 'events') {
      return this.http.post<TData>(
        `${this.baseUrl}/api/v1/admin/comings/category/`,
        comingCategoryCreate,
        {
          ...(options as Omit<NonNullable<typeof options>, 'observe'>),
          observe: 'events',
  ...
  adminComingsCategoryRetrieve<TData = ComingCategoryList>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`${this.baseUrl}/api/v1/admin/comings/category/${id}/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
      });
    }
  ...
  adminComingsCategoryUpdate<TData = ComingCategoryUpdate>(
    id: number,
    comingCategoryUpdate: ComingCategoryUpdate,
    options?: HttpClientBodyOptions,
  ): Observable<TData>;
  adminComingsCategoryUpdate<TData = ComingCategoryUpdate>(
    id: number,
  ...
  adminComingsCategoryUpdate<TData = ComingCategoryUpdate>(
    ...
    if (options?.observe === 'events') {
      return this.http.put<TData>(
        `${this.baseUrl}/api/v1/admin/comings/category/${id}/`,
        comingCategoryUpdate,
        {
          ...(options as Omit<NonNullable<typeof options>, 'observe'>),
          observe: 'events',
  ...
  adminComingsCategoryDestroy<TData = void>(
    ...
    if (options?.observe === 'events') {
      return this.http.delete<TData>(`${this.baseUrl}/api/v1/admin/comings/category/${id}/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
      });
    }
