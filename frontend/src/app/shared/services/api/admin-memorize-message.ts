...
export class AdminMemorizeMessageService {
  ...
  adminActionsMemorizeMessageDeleteCreate<TData = void>(
    ...
    if (options?.observe === 'events') {
      return this.http.post<TData>(
        `${this.baseUrl}/api/v1/admin/actions/memorize-message/delete`,
        idsAction,
        {
  ...
  adminStudentsMemorizeMessageList<TData = PaginatedMemorizeMessageListList>(
    params?: AdminStudentsMemorizeMessageListParams,
    options?: HttpClientBodyOptions,
  ): Observable<TData>;
  adminStudentsMemorizeMessageList<TData = PaginatedMemorizeMessageListList>(
    params?: AdminStudentsMemorizeMessageListParams,
  ...
  adminStudentsMemorizeMessageList<TData = PaginatedMemorizeMessageListList>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`${this.baseUrl}/api/v1/admin/students/memorize-message/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
  ...
  adminStudentsMemorizeMessageRetrieve<TData = MemorizeMessageList>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`${this.baseUrl}/api/v1/admin/students/memorize-message/${id}/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
      });
    }
  ...
  adminStudentsMemorizeMessageDestroy<TData = void>(
    ...
    if (options?.observe === 'events') {
      return this.http.delete<TData>(
        `${this.baseUrl}/api/v1/admin/students/memorize-message/${id}/`,
        {
          ...(options as Omit<NonNullable<typeof options>, 'observe'>),
          observe: 'events',
        },
