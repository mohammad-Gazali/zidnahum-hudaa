...
export class AdminPointsAddingService {
  ...
  adminActionsPointsAddingDeleteCreate<TData = void>(
    ...
    if (options?.observe === 'events') {
      return this.http.post<TData>(
        `${this.baseUrl}/api/v1/admin/actions/points-adding/delete`,
        idsAction,
        {
  ...
  adminPointsAddingList<TData = AdminPaginatedpointsaddingListlist>(
    params?: AdminPointsAddingListParams,
    options?: HttpClientBodyOptions,
  ): Observable<TData>;
  adminPointsAddingList<TData = AdminPaginatedpointsaddingListlist>(
    params?: AdminPointsAddingListParams,
  ...
  adminPointsAddingList<TData = AdminPaginatedpointsaddingListlist>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`${this.baseUrl}/api/v1/admin/points/adding/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
  ...
  adminPointsAddingRetrieve<TData = AdminPointsaddingList>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`${this.baseUrl}/api/v1/admin/points/adding/${id}/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
      });
    }
  ...
  adminPointsAddingDestroy<TData = void>(
    ...
    if (options?.observe === 'events') {
      return this.http.delete<TData>(`${this.baseUrl}/api/v1/admin/points/adding/${id}/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
      });
    }
