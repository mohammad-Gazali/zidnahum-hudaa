...
export class AdminNewsService {
  ...
  adminActionsNewsDeleteCreate<TData = void>(
    ...
    if (options?.observe === 'events') {
      return this.http.post<TData>(`${this.baseUrl}/api/v1/admin/actions/news/delete`, idsAction, {
  ...
  adminGlobalsNewsList<TData = PaginatedNewsListList>(
    params?: AdminGlobalsNewsListParams,
    options?: HttpClientBodyOptions,
  ): Observable<TData>;
  adminGlobalsNewsList<TData = PaginatedNewsListList>(
    params?: AdminGlobalsNewsListParams,
  ...
  adminGlobalsNewsList<TData = PaginatedNewsListList>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`${this.baseUrl}/api/v1/admin/globals/news/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
  ...
  adminGlobalsNewsCreate<TData = NewsCreate>(
    ...
    if (options?.observe === 'events') {
      return this.http.post<TData>(`${this.baseUrl}/api/v1/admin/globals/news/`, formData, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
      });
    }
  ...
  adminGlobalsNewsRetrieve<TData = NewsList>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`${this.baseUrl}/api/v1/admin/globals/news/${id}/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
      });
    }
  ...
  adminGlobalsNewsDestroy<TData = void>(
    ...
    if (options?.observe === 'events') {
      return this.http.delete<TData>(`${this.baseUrl}/api/v1/admin/globals/news/${id}/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
      });
    }
