...
export class AdminGroupService {
  ...
  adminActionsGroupDeleteCreate<TData = void>(
    ...
    if (options?.observe === 'events') {
      return this.http.post<TData>(`${this.baseUrl}/api/v1/admin/actions/group/delete`, idsAction, {
  ...
  adminAuthGroupList<TData = GroupList[]>(
    params?: AdminAuthGroupListParams,
    options?: HttpClientBodyOptions,
  ): Observable<TData>;
  adminAuthGroupList<TData = GroupList[]>(
    params?: AdminAuthGroupListParams,
  ...
  adminAuthGroupList<TData = GroupList[]>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`${this.baseUrl}/api/v1/admin/auth/group/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
  ...
  adminAuthGroupCreate<TData = GroupCreate>(
    ...
    if (options?.observe === 'events') {
      return this.http.post<TData>(`${this.baseUrl}/api/v1/admin/auth/group/`, groupCreate, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
      });
    }
  ...
  adminAuthGroupRetrieve<TData = GroupList>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`${this.baseUrl}/api/v1/admin/auth/group/${id}/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
      });
    }
  ...
  adminAuthGroupUpdate<TData = GroupUpdate>(
    ...
    if (options?.observe === 'events') {
      return this.http.put<TData>(`${this.baseUrl}/api/v1/admin/auth/group/${id}/`, groupUpdate, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
      });
    }
  ...
  adminAuthGroupDestroy<TData = void>(
    ...
    if (options?.observe === 'events') {
      return this.http.delete<TData>(`${this.baseUrl}/api/v1/admin/auth/group/${id}/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
      });
    }
