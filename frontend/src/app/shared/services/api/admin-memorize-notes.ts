...
export class AdminMemorizeNotesService {
  ...
  adminActionsMemorizeNotesDeleteCreate<TData = void>(
    ...
    if (options?.observe === 'events') {
      return this.http.post<TData>(
        `${this.baseUrl}/api/v1/admin/actions/memorize-notes/delete`,
        idsAction,
        {
  ...
  adminStudentsMemorizeNotesList<TData = PaginatedMemorizeNotesListList>(
    params?: AdminStudentsMemorizeNotesListParams,
    options?: HttpClientBodyOptions,
  ): Observable<TData>;
  adminStudentsMemorizeNotesList<TData = PaginatedMemorizeNotesListList>(
    params?: AdminStudentsMemorizeNotesListParams,
  ...
  adminStudentsMemorizeNotesList<TData = PaginatedMemorizeNotesListList>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`${this.baseUrl}/api/v1/admin/students/memorize-notes/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
  ...
  adminStudentsMemorizeNotesRetrieve<TData = MemorizeNotesList>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`${this.baseUrl}/api/v1/admin/students/memorize-notes/${id}/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
      });
    }
  ...
  adminStudentsMemorizeNotesDestroy<TData = void>(
    ...
    if (options?.observe === 'events') {
      return this.http.delete<TData>(
        `${this.baseUrl}/api/v1/admin/students/memorize-notes/${id}/`,
        {
          ...(options as Omit<NonNullable<typeof options>, 'observe'>),
          observe: 'events',
        },
    ...
    return this.http.delete<TData>(`${this.baseUrl}/api/v1/admin/students/memorize-notes/${id}/`, {
      ...(options as Omit<NonNullable<typeof options>, 'observe'>),
      observe: 'body',
    });
  }
