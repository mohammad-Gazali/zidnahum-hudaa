...
export class AdminAssetFileService {
  ...
  adminActionsAssetFileDeleteCreate<TData = void>(
    ...
    if (options?.observe === 'events') {
      return this.http.post<TData>(
        `${this.baseUrl}/api/v1/admin/actions/asset-file/delete`,
        idsAction,
        {
  ...
  adminGlobalsAssetFileList<TData = PaginatedAssetFileListList>(
    params?: AdminGlobalsAssetFileListParams,
    options?: HttpClientBodyOptions,
  ): Observable<TData>;
  adminGlobalsAssetFileList<TData = PaginatedAssetFileListList>(
    params?: AdminGlobalsAssetFileListParams,
  ...
  adminGlobalsAssetFileList<TData = PaginatedAssetFileListList>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`${this.baseUrl}/api/v1/admin/globals/asset-file/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
  ...
  adminGlobalsAssetFileCreate<TData = AssetFileCreate>(
    assetFileCreate: AssetFileCreate,
    options?: HttpClientBodyOptions,
  ): Observable<TData>;
  adminGlobalsAssetFileCreate<TData = AssetFileCreate>(
    assetFileCreate: AssetFileCreate,
  ...
  adminGlobalsAssetFileCreate<TData = AssetFileCreate>(
    ...
    if (options?.observe === 'events') {
      return this.http.post<TData>(`${this.baseUrl}/api/v1/admin/globals/asset-file/`, formData, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
      });
    }
  ...
  adminGlobalsAssetFileRetrieve<TData = AssetFileList>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`${this.baseUrl}/api/v1/admin/globals/asset-file/${id}/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
      });
    }
  ...
  adminGlobalsAssetFileDestroy<TData = void>(
    ...
    if (options?.observe === 'events') {
      return this.http.delete<TData>(`${this.baseUrl}/api/v1/admin/globals/asset-file/${id}/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
      });
    }
