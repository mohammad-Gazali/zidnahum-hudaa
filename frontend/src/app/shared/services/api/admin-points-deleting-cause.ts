...
export class AdminPointsDeletingCauseService {
  ...
  adminActionsPointsDeletingCauseDeleteCreate<TData = void>(
    ...
    if (options?.observe === 'events') {
      return this.http.post<TData>(
        `${this.baseUrl}/api/v1/admin/actions/points-deleting-cause/delete`,
        idsAction,
        {
  ...
  adminPointsDeletingCauseList<TData = PointsDeletingCauseList[]>(
    params?: AdminPointsDeletingCauseListParams,
    options?: HttpClientBodyOptions,
  ): Observable<TData>;
  adminPointsDeletingCauseList<TData = PointsDeletingCauseList[]>(
    params?: AdminPointsDeletingCauseListParams,
  ...
  adminPointsDeletingCauseList<TData = PointsDeletingCauseList[]>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`${this.baseUrl}/api/v1/admin/points/deleting-cause/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
  ...
  adminPointsDeletingCauseCreate<TData = PointsDeletingCauseCreate>(
    pointsDeletingCauseCreate: PointsDeletingCauseCreate,
    options?: HttpClientBodyOptions,
  ): Observable<TData>;
  adminPointsDeletingCauseCreate<TData = PointsDeletingCauseCreate>(
    pointsDeletingCauseCreate: PointsDeletingCauseCreate,
  ...
  adminPointsDeletingCauseCreate<TData = PointsDeletingCauseCreate>(
    ...
    if (options?.observe === 'events') {
      return this.http.post<TData>(
        `${this.baseUrl}/api/v1/admin/points/deleting-cause/`,
        pointsDeletingCauseCreate,
        {
          ...(options as Omit<NonNullable<typeof options>, 'observe'>),
          observe: 'events',
  ...
  adminPointsDeletingCauseRetrieve<TData = PointsDeletingCauseList>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`${this.baseUrl}/api/v1/admin/points/deleting-cause/${id}/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
      });
    }
  ...
  adminPointsDeletingCauseUpdate<TData = PointsDeletingCauseUpdate>(
    id: number,
    pointsDeletingCauseUpdate: PointsDeletingCauseUpdate,
    options?: HttpClientBodyOptions,
  ): Observable<TData>;
  adminPointsDeletingCauseUpdate<TData = PointsDeletingCauseUpdate>(
    id: number,
  ...
  adminPointsDeletingCauseUpdate<TData = PointsDeletingCauseUpdate>(
    ...
    if (options?.observe === 'events') {
      return this.http.put<TData>(
        `${this.baseUrl}/api/v1/admin/points/deleting-cause/${id}/`,
        pointsDeletingCauseUpdate,
        {
          ...(options as Omit<NonNullable<typeof options>, 'observe'>),
          observe: 'events',
  ...
  adminPointsDeletingCauseDestroy<TData = void>(
    ...
    if (options?.observe === 'events') {
      return this.http.delete<TData>(`${this.baseUrl}/api/v1/admin/points/deleting-cause/${id}/`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
      });
    }
