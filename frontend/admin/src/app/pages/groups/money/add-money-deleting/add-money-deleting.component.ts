...
export class AddMoneyDeletingComponent extends MoneyBase {
  ...
  public normalForm = this.fb.group({
    cause: this.fb.nonNullable.control<number | undefined>(undefined, [Validators.required]),
    value: this.fb.nonNullable.control<number | undefined>(undefined, [Validators.required]),
  });

  public categoryForm = this.fb.group({
    masjed: this.fb.nonNullable.control<1 | 2 | 3 | undefined>(undefined, [Validators.required]),
    category: this.fb.nonNullable.control<number | undefined>(undefined, [Validators.required]),
    cause: this.fb.nonNullable.control<number | undefined>(undefined, [Validators.required]),
    value: this.fb.nonNullable.control<number | undefined>(undefined, [Validators.required]),
  });
  ...
  public normalSubmit(form: FormGroupDirective) {
    ...
    this.extra.extraAddMoneyDeletingNormalCreate({
  ...
  public categorySubmit(form: FormGroupDirective) {
    ...
    this.extra.extraAddMoneyDeletingCategoryCreate({
